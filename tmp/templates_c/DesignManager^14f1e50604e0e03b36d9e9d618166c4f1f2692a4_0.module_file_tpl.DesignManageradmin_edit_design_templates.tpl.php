...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.2',
  'unifunc' => 'content_6807810f7f66b7_21260680',
...
function content_6807810f7f66b7_21260680 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\cms\\cms\\lib\\smarty\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),1=>array('file'=>'C:\\xampp\\htdocs\\cms\\cms\\lib\\plugins\\function.cms_action_url.php','function'=>'smarty_cms_function_cms_action_url',),));
?>
<style type="text/css">
        ...
        <fieldset>
            ...
            <div id="selected-templates">
                <ul class="sortable-templates sortable-list selected-templates">
                    <?php if (smarty_modifier_count((($tmp = $_smarty_tpl->tpl_vars['design']->value->get_templates() ?? null)===null||$tmp==='' ? array() ?? null : $tmp)) == 0) {?><li class="placeholder no-sort"><?php echo $_smarty_tpl->tpl_vars['mod']->value->Lang('drop_items');?>
</li><?php }?>
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_templates']->value, 'tpl');
$_smarty_tpl->tpl_vars['tpl']->do_else = true;
